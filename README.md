...
```
mkdir concatenation
mv *phy concatenation
cd concatenation
perl FASconCAT-G_v1.04.pl -l -s -p
mv FcC_supermatrix.fas vert_20g_filtered_g08.fa
mv FcC_supermatrix_partition.txt vert_20g_filtered_g08.part
```
...
```
iqtree -s vert_20g_filtered_g08.fa -m TEST -merit BIC -bb 1000 -alrt 1000 -nt 4 -pre unpartitioned
```
...
```
iqtree -s vert_20g_filtered_g08.fa -spp vert_20g_filtered_g08.part -m TEST -merit AICc -bb 1000 -alrt 1000 -nt 4 -pre partitioned
```
...
```
iqtree -s vert_20g_filtered_g08.fa -m JTT+G+C60 -bb 1000 -alrt 1000 -nt 4 -pre mixture_model
```
